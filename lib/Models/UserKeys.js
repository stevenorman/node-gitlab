(function() {
  ...
  UserKeys = (function(superClass) {
    ...
    function UserKeys() {
      this.deleteKey = bind(this.deleteKey, this);
    ...
    UserKeys.prototype.deleteKey = function(userId, keyId, fn) {
      if (fn == null) {
        fn = null;
      }
      return this["delete"]("users/" + userId + "/keys/" + (parseInt(keyId)), function(data) {
        if (fn) {
          return fn(data);
        }
      });
